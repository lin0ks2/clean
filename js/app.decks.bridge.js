 ...
 * ========================================================== */
/* ==========================================================
 * app.decks.bridge.js — универсальный «мост» виртуальных словарей
 *  - Делает mistakes:<lang>:<baseKey> и favorites:<lang>:<baseKey> полноценными словарями
 *  - Прокидывает имя/флаг/язык базового словаря
 * ========================================================== */
(function(){
  'use strict';
