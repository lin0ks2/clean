...
(function(){
  ...
  window.I18N = {
    ...
    ru: {
      ...
      infoSteps: [
        "Увидели слово — выберите перевод.",
        "Отмечайте важные слова, чтобы вернуться к ним позже.",
        "Используйте кнопку «Не знаю» — продвигайтесь дальше."
      ],
    ...
    uk: {
      ...
      infoSteps: [
        "Побачили слово — оберіть переклад.",
        "Позначайте важливі слова, щоб повернутися до них пізніше.",
        "Користуйтесь кнопкою «Не знаю» — рухайтесь далі."
      ],
